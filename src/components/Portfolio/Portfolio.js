  ...
  return (
    <div class="flex-container-portfolio justify-content-evenly ">
      <div class="row-portfolio" id="portfolio">
        <div class="flex-container-portfolio justify-content-evenly">
          <img src="assets/ACT-Media.jpg" class="portpic" alt="pic1" />
        </div>
        <h2>What We Do ?</h2>
        <hr />
        <p className="par">
          ...
          effectively to shoppers in-store, where the final purchase decision is
          made. We create our in-store advertising with ActMedia’s unique
          sensorial- based creatives, including shelf-media, digital signages
          and in-store Taste and Touch.​ ​
        </p>
      </div>
      <div class="flex-container-portfolio justify-content-evenly">
        <img src="assets/cokexmass.jpg" class="portpic2 img-fluid" alt="pic2" />
      </div>
    </div>
  );
};
